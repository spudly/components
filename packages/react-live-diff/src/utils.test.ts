...
describe('getPosition', () => {
  test('gets position by index', () => {
    ...
    expect(getPosition(value, 0)).toStrictEqual({line: 1, column: 1});
    expect(getPosition(value, 1)).toStrictEqual({line: 1, column: 2});
    expect(getPosition(value, 2)).toStrictEqual({line: 1, column: 3});
    expect(getPosition(value, 3)).toStrictEqual({line: 1, column: 4});
    expect(getPosition(value, 4)).toStrictEqual({line: 2, column: 1});
    expect(getPosition(value, 5)).toStrictEqual({line: 2, column: 2});
    expect(getPosition(value, 6)).toStrictEqual({line: 2, column: 3});
    expect(getPosition(value, 7)).toStrictEqual({line: 2, column: 4});
    expect(getPosition(value, 8)).toStrictEqual({line: 3, column: 1});
    expect(getPosition(value, 9)).toStrictEqual({line: 3, column: 2});
    expect(getPosition(value, 10)).toStrictEqual({line: 3, column: 3});
    expect(getPosition(value, 11)).toStrictEqual({line: 3, column: 4});
    expect(getPosition(value, 12)).toStrictEqual({line: 3, column: 5});
    expect(getPosition(value, 13)).toStrictEqual({line: 3, column: 6});
